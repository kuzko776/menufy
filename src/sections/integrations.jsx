export const Integrations = () => (
    <>
      {/* Section 1 */}
      <section id="integration" className="py-12 sm:py-16">
        <div className="max-w-7xl px-10 mx-auto sm:text-center">
          <p className="text-yellow-500 font-medium uppercase">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 my-12 sm:my-16">
            <div className="rounded-lg py-10 flex flex-col items-center justify-center shadow-lg border border-gray-100">
              ...
              <p className="mt-2 text-sm text-gray-400">Connect to 1,000+ apps</p>
            </div>
            <div className="rounded-lg py-10 flex flex-col items-center justify-center shadow-lg border border-gray-100">
              <svg
                className="w-16 h-auto"
              ...
              <p className="mt-2 text-sm text-gray-400">Messaging Platform</p>
            </div>
            <div className="rounded-lg py-10 flex flex-col items-center justify-center shadow-lg border border-gray-100">
              <svg
                className="w-16 h-auto"
              ...
              <p className="mt-2 text-sm text-gray-400">Customer Relations</p>
            </div>
            <div className="rounded-lg py-10 flex flex-col items-center justify-center shadow-lg border border-gray-100">
              <svg
                className="w-16 h-auto"
              ...
              <p className="mt-2 text-sm text-gray-400">Customer Messaging</p>
            </div>
            <div className="rounded-lg py-10 flex flex-col items-center justify-center shadow-lg border border-gray-100">
              <svg
                className="w-16 h-auto"
              ...
              <p className="mt-2 text-sm text-gray-400">Data Management</p>
            </div>
            <div className="rounded-lg py-10 flex flex-col items-center justify-center shadow-lg border border-gray-100">
              <svg
                className="w-16 h-auto"
              ...
              <p className="mt-2 text-sm text-gray-400">Web Tag Manager</p>
            </div>
            <div className="rounded-lg py-10 flex flex-col items-center justify-center shadow-lg border border-gray-100">
              <svg
                className="w-16 h-auto"
              ...
              <p className="mt2 text-sm text-gray-400">Email Marketing</p>
            </div>
            <div className="rounded-lg py-10 flex flex-col items-center justify-center shadow-lg border border-gray-100">
              <svg
              ...
              >
                <path
                  ...
                  fill="#34A853"
                />
                <path d="M250.001 85.16h-86.182V0l86.182 85.16Z" fill="#188038" />
                <path
